            ...
            <form action="" method="">
                ...
                <input type="hidden" name="id" value="<?php echo $id; ?>">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nis" value="<?php echo $nis; ?>" disabled>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="exampleFormControlInput1">Jurusan</label>
                            <select id="inputPendidikan" name="jurusan" class="form-control" disabled>
                    ...
                    <div class="form-group">
                        <label for="exampleFormControlInput1">Kelas</label>
                            <select id="inputPendidikan" name="kelas" class="form-control" disabled>
